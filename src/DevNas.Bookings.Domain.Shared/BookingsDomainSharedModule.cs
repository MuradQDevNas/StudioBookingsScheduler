...
public class BookingsDomainSharedModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<BookingsDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<BookingsResource>("ar")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/Bookings");

            options.DefaultResourceType = typeof(BookingsResource);
        ...
        {
            options.MapCodeNamespace("Bookings", typeof(BookingsResource));
        });
    }
}
