...
public class StudioBookingSystemDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public StudioBookingSystemDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
