...
```
127.0.0.1 studiobookingsystem-local-web
127.0.0.1 studiobookingsystem-local-webgateway
127.0.0.1 studiobookingsystem-local-authserver
```
...
Now, you can browse the URL: `https://studiobookingsystem-local-web`
